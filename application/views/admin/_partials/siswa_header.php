				...
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						<li class="active has-sub">
							<a class="js-arrow" href="<?= base_url('admin/User') ?>">
								<i class="fas fa-tachometer-alt"></i>Dashboard</a>
							...
							<div class="header-button">
								...
								<div class="account-wrap">
									<div class="account-item clearfix js-item-menu">
										<div class="image">
											<img src="https://media1.giphy.com/media/KySp80cQrHqWyM0ojC/200w.gif" alt="John Doe" />
										</div>
										<div class="content">
											<a class="js-acc-btn" href="#"><?php $kecoa = $this->session->userdata('siswa');
																			echo $kecoa['username']; ?></a>
										</div>
										<div class="account-dropdown js-dropdown">
											<div class="info clearfix">
												...
												<div class="content">
													<h5 class="name">
														<a href="#"><?php $kecoa = $this->session->userdata('siswa');
																	echo $kecoa['username']; ?></a>
													</h5>
													<span class="email">Siswa</span>
												</div>
											</div>
